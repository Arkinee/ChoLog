...
public class LookOfflineAdapter extends RecyclerView.Adapter<LookOfflineAdapter.ViewHolder> {
    ...
    public LookOfflineAdapter(Context mContext, ArrayList<LookItem> mPupularList) {
