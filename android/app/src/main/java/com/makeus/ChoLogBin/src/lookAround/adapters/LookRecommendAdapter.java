package com.makeus.ChoLogBin.src.lookAround.adapters;
...
public class LookRecommendAdapter extends RecyclerView.Adapter<LookRecommendAdapter.ViewHolder> {
    ...
    public LookRecommendAdapter(Context mContext, ArrayList<LookItem> mPupularList) {
