...
public class LookOnlineAdapter extends RecyclerView.Adapter<LookOnlineAdapter.ViewHolder> {
    ...
    public LookOnlineAdapter(Context mContext, ArrayList<LookItem> mPupularList) {
