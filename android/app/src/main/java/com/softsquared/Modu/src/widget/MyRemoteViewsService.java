...
import com.softsquared.Modu.src.widget.model.WidgetItem;
...
class MyRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        rv.setTextViewText(R.id.tv_widget_item, "1");
        ...
        rv.setOnClickFillInIntent(R.id.tv_widget_item, fillInIntent);
