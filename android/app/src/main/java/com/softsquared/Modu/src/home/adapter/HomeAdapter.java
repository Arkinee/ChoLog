package com.softsquared.Modu.src.home.adapter;
...
import static com.softsquared.Modu.src.ApplicationClass.HOME_DAY;
import static com.softsquared.Modu.src.ApplicationClass.HOME_MONTH;
...
//            });
    ...
    // onBindViewHolder() - position 해당하는 데이터를 뷰홀더의 아이템뷰에 표시.
    @Override
