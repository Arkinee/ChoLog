...
public class WidgetProvider extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.softsquared.Modu.src.widget.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.softsquared.Modu.src.widget.EXTRA_ITEM";
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < appWidgetIds.length; ++i) {
            ...
            RemoteViews rv = new RemoteViews(context.getPackageName(), R.layout.widget_modu);
            ...
            rv.setPendingIntentTemplate(R.id.lv_widget, toastPendingIntent);
